...
.register-side {
    ...
    align-items: center; /* center perfectly again */
    background: #3a3838ff;
    padding: 20px;
}
...
.image-side {
    flex: 2;
    background-image: url('../Assets/Templates/Main/images/U1.jpg');
...
.register-side {
    ...
    padding-top: 40px;             /* add some breathing space at top */
    background: #3a3838ff;
}
/* Box design */
.register-box {
    ...
    <div class="register-side">
        <div class="register-box">
            ...
            if(isset($_POST["btn_submit"]))
            {
                ...
                $proof=$_FILES["pht_proof"]["name"];
                $tempProof=$_FILES["pht_proof"]["tmp_name"];
                move_uploaded_file($tempProof,"../Assets/files/UserPhotos/".$proof);
                
                $district=$_POST['sel_district'];
                $place=$_POST['sel_place'];
                $password=$_POST['txt_password'];
                $insQry = "INSERT INTO tbl_seller(
                    seller_name, seller_email, seller_contact, seller_address, seller_photo, seller_proof, seller_password, place_id, seller_status
                ) VALUES (
                    '".$name."', '".$email."', '".$contact."', '".$address."', '".$photo."', '".$proof."', '".$password."', '".$place."', 0
                )";
            ...
            <form action="" method="post" enctype="multipart/form-data">
                <table cellpadding="5">
                    ...
                    <tr>
                        <td>Proof</td>
                        <td><input type="file" name="pht_proof"></td>
                    </tr>
                    <tr>
                        <td>District</td>
                        <td>
                    ...
                    <tr>
                        <td>Password</td>
                        <td><input type="password" name="txt_password" required
                            pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" 
                            title="At least 8 characters, 1 uppercase, 1 lowercase, 1 number"></td>
                    </tr>
                    <tr>
