...
$rentbooking_id = $_GET['bid'];

$selBookingQuery = "SELECT * FROM tbl_rentproductbooking WHERE rentproductbooking_id='" . $rentbooking_id . "'";
$rentbookingResult = $con->query($selBookingQuery);
$rentbookingData = $rentbookingResult->fetch_assoc();
$rentbookingAmount = $rentbookingData["rentproductbooking_amount"];

if (isset($_POST["btn_pay"])) {
    
    $updateBookingStatusQuery = "UPDATE tbl_rentproductbooking SET rentproductbooking_status='3' WHERE rentproductbooking_id='" . $rentbooking_id . "'";
    if ($con->query($updateBookingStatusQuery)) {

        
?>
        <script>
            window.location = "Loader.php?amt=<?php echo $rentbookingAmount ?>";
        </script>
<?php
    } else {
?>
